...
class NewGroupeChat extends StatefulWidget {
  @override
  _NewGroupeChatState createState() => _NewGroupeChatState();
}

class _NewGroupeChatState extends State<NewGroupeChat> {
  ChatModel currentChat = ChatModel.list.elementAt(0);
  ChatModel currentChat2 = ChatModel.list.elementAt(1); //pour current discuss
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("${currentChat.contact.nom}" "${currentChat2.contact.nom}"),
        centerTitle: true,
      ),
